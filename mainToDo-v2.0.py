...
class MyMainWindow(QMainWindow, Ui_importRawTool):
    ...
    def retranslateUi(self, importRawTool):
        ...
        self.label_6.setText(_translate("importRawTool",
                                        "<html><head/><body><p><span style=\" font-weight:600;\">图片目标路径：</span></p></body></html>"))
        self.label_9.setText(_translate("importRawTool",
                                        "<html><head/><body><p><span style=\" font-weight:600;\">成图存储路径</span></p></body></html>"))
        self.label_12.setText(_translate("importRawTool",
                                         "<html><head/><body><p><span style=\" font-weight:600;\">启动应用程序</span></p></body></html>"))
